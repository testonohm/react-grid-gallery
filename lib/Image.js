...
var Image = function (_Component) {
    ...
    _createClass(Image, [{
        ...
        key: 'cunstomStyle',
        value: function cunstomStyle() {
            return this.props.cunstomStyle.call(this);
        }
    }, {
        key: 'thumbnailStyle',
        value: function thumbnailStyle() {
            ...
            if (this.props.item.isSelected) {
                ...
                return {
                    ...
                    borderRadius: '.25em',
                    background: `center / 70% no-repeat url(${this.props.item.soldOut}),
                        center / cover no-repeat url(${this.props.item.thumbnail})`,
                };
            }
            return {
                cursor: 'pointer',
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('div', {
                        key: "img2-" + this.props.index,
                        style: this.thumbnailStyle() }),

                    // _react2.default.createElement('div', {
                    //     key: "img2-" + this.props.index,
                    //     style: this.cunstomStyle() }),
                    // _react2.default.createElement('img', {
                    //     key: "img2-" + this.props.index,
                    //     src: this.props.item.soldOut,
                    //     style: this.props.soldOutStyle }),
                    // _react2.default.createElement('img', {
...
Image.propTypes = {
    ...
    soldOutStyle: _propTypes2.default.object,
    cunstomStyle: _propTypes2.default.func,
};
